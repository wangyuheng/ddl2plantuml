...
class ErParser {
    ...
    companion object {
        ...
        fun parse(table: Table): String {
            return Template.ER_HEADER + getTableStrs(table) + Template.ER_FOOTER
        }

        private fun getTableStrs(table: Table): String {
           return Template.TABLE_LINE.replace(Template.TABLE_NAME.toRegex(), table.name)
